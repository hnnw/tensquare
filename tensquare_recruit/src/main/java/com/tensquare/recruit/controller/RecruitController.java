...
public class RecruitController {
	...
	public Result findByState(){
		List<Recruit> state = recruitService.findByState();
		return new Result(true,StatusCode.OK,"查询推荐职位成功",state);
	}

	@GetMapping("/search/newlist")
	public Result findByNewlist(){
		List<Recruit> state = recruitService.findByNew();
		return new Result(true,StatusCode.OK,"查询最新职位成功",state);
	}
