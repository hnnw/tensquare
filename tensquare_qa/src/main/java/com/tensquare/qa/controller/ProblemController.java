...
public class ProblemController {
	...
	public Result findHotProblem(@PathVariable("label") String id,
								 @PathVariable("page") Integer page,
								 @PathVariable("size") Integer size){
		Page<Problem> newProblem = problemService.findHotProblem(id, page, size);
		return new Result(true,StatusCode.OK,"查询热门回答",new PageResult<Problem>(newProblem.getTotalElements(),newProblem.getContent()));
	}
